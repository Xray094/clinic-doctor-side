...
import { 
  Mail, Lock, Eye, EyeOff, Calendar, Pill, 
...
export default function LoginPage() {
  ...
  const getInputWrapperClass = (fieldName) => `
    flex items-center rounded-xl border transition-all duration-200 bg-[#f7fdfc]
    ${errors[fieldName] 
  ...
  return (
    <div className="flex min-h-screen font-sans overflow-hidden bg-medics-bg">
      ...
      {/* ── LEFT PANEL (Branding) ── */}
      <div className="hidden lg:flex flex-col justify-between w-5/12 relative overflow-hidden px-10 py-10 bg-gradient-to-br from-medics-primary via-medics-secondary to-[#12827a]">
        ...
        <div className="flex items-center gap-3 relative z-10">
          <div className="w-11 h-11 rounded-xl flex items-center justify-center bg-white/20">
            <img className="w-7 h-7" src="src/assets/Medics-Logo.png" alt="Medics Logo" />
          </div>
          <span className="text-white text-2xl font-black tracking-wide">Medics</span>
        </div>
        ...
        <div className="relative z-10 text-center">
          <div className="flex justify-center mb-6">
            <div className="w-28 h-28 rounded-3xl flex items-center justify-center shadow-xl bg-white/20">
              <img className="w-16 h-16" src="src/assets/Medics-Logo.png" alt="Hero Logo" />
            </div>
          </div>
          ...
          <p className="text-white/70 text-sm max-w-xs mx-auto leading-relaxed">
            A seamless platform for modern doctors to deliver better, faster, smarter care.
          </p>
        </div>
        ...
        <div className="relative z-10 space-y-3">
          {[
            ...
            <div key={i} className="flex items-center gap-3 rounded-xl px-4 py-3 bg-white/10 backdrop-blur-md">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        <div className={`w-full max-w-md bg-white rounded-3xl shadow-2xl px-9 py-10 border border-medics-light `}>
          ...
          <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
            <div className="flex flex-col items-center text-center mb-8">
               <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-4 bg-gradient-to-br from-medics-primary to-medics-secondary shadow-lg shadow-medics-primary/30">
                  <img className="w-8 h-8" src="src/assets/Medics-Logo.png" alt="Form Logo" />
               </div>
              <h1 className="text-2xl font-black text-medics-dark mb-1">Sign in to Medics</h1>
              <p className="text-sm font-medium text-[#7aada9]">Doctor Portal Access</p>
            </div>

            {/* Email Input */}
            <div className="space-y-1.5">
              <label htmlFor="email" className="block text-xs font-bold text-[#4a7a76] uppercase tracking-widest ml-1">Email Address</label>
            ...
            {/* Password Input */}
            <div className="space-y-1.5">
              <label htmlFor="password" className="block text-xs font-bold text-[#4a7a76] uppercase tracking-widest ml-1">Password</label>
        ...
        <p className="mt-8 text-xs text-[#b0d4d1]">© 2026 Medics System • Clinical Standard v4.2</p>
      </div>
    </div>
  );
}